...
//This hook detects click outside of the specified component and calls the provoded handler function
export default function useOnClickOutside(ref,handler){
   useEffect(()=>{
    ...
    /* Cleanup function to remove the event listeners when the component
     unmounts or when the ref/handler dependencies change*/
     return()=>{
