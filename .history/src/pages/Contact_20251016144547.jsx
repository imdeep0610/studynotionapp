...
const Contact = () => {
  return (
    <div className='flex gap-x-10 justify-center items-center mx-auto mt-20'>
        {/*Left part*/}
         <div className='flex flex-col gap-y-5 justify-start items-start bg-richblack-800 p-10'>
            {/*1st part*/}
            <div className='flex flex-col gap-y-3'>
                <div className='flex gap-x-3'>
                   <BiSolidMessageRoundedDots className='bg-richblack-200'/>
            ...
            <div className='flex flex-col gap-y-3'>
                <div className='flex gap-x-3'>
                   <IoEarthSharp className='bg-richblack-200' />
            ...
            <div className='flex flex-col gap-y-3'>
                <div className='flex gap-x-3'>
                   <FaPhone className='bg-richblack-200'/>
