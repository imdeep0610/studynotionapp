...
const Contact = () => {
  return (
    ...
    {/*Section2*/}
    <section>
         <div className='flex flex-col gap-y-5 justify-center items-center mx-auto mb-5'>
           <h2 className='text-richblack-5 text-3xl font-bold mb-'>Review from other learners</h2>
           {/*<ReviewSlider/>*/} 
         </div>
      </section>
    </div>
