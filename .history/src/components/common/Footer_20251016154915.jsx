                    ...
                    <div className='flex flex-col gap-3'>
                     <p className='text-richblack-5 font-semibold'>Resources</p>
                     {
                      Resources.map((item,index)=>(
                        <Link to={item.toLowerCase()}  key={index} 
                        className='text-richblack-500 font-medium gap-3'>
                           {item}
                        </Link>
                      ))
                     }
                     ...
                     <div className='flex flex-col gap-3'>
                       ...
                       <Link to={'/help-center'} 
                       className='text-richblack-500 font-medium'>Help Center</Link>
                     </div>
                  </div>
                  <div className='flex flex-col gap-8'>
                      <div className='flex flex-col gap-3'>
                         <p className='text-richblack-5 font-semibold'>Plans</p>
                         {
                          Plans.map((item,index)=>(
                            <Link to={item.toLowerCase()}  key={index}
                            className='text-richblack-500 font-medium'>{item}</Link>
                          ))
                         }
                      </div>
                      <div className='flex flex-col gap-3'>
