   ...
   return(
     <div className="bg-richblack-800 mb-10">
         <div className="w-11/12 flex flex-col items-center gap-10 px-16">
             {/*Bigger box*/}
             <div className="flex mt-16 w-full  border-b mx-auto border-richblack-300 h-[75%]">
               {/*Left one*/}
                      ...
                      <div key={ele.title} className='flex flex-col gap-3'>
                       <p className='text-richblack-5 font-semibold'>
                        {ele.title}
                         ...
                         <div className="flex flex-col gap-3">
  {FooterLink2.links.map((item) => (
    <Link
      to={item.link}
      key={item.link}
      className="text-richblack-500 font-medium hover:text-richblack-100 transition whitespace-nowrap"
    >
      {item.title}
    </Link>
  ))}
