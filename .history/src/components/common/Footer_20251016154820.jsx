                      ...
                      <div className='flex flex-col gap-3'>
                         <p className='text-richblack-5 font-semibold'>Community</p>
                         {
                          Community.map((item,index)=>(
                            <Link to={item.toLowerCase()} key={index}
                            className='text-richblack-500 font-mediym'>{item}</Link>
                          ))
                         }
                      </div>
                  </div>
                         ...
                         <div>
                          {
                             ele.links.map((item,index)=>(
                               ...
                               className='text-richblack-500 font-medium gap-5 hover:text-richblack-100 transition whitespace-nowrap'>
                                 {item.title}
                               </Link>
                             ))
                          }
