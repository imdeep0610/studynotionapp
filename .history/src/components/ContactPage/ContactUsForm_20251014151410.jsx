        ...
        <div className='flex flex-col gap-y-5'>
          <div className='flex gap-x-5'>
            <div className='flex flex-col '>
             ...
             className='mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5 gap-y-5'>
              First Name
            </label>
             <input
             type='text'
             ...
             <div>
             <label htmlFor='lastName' className='mb-1 gap-y-5 text-[0.875rem] leading-[1.375rem] text-richblack-5'>
              Last Name
            </label>
             <input
             type='text'
