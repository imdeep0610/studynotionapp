          ...
          <div className='flex flex-col'>
            ...
            <div className='flex gap-x-3 w-full'>
               ...
               style={{
                 ...
                 {countrycode.map((data,index)=>(
                  ...
                  style={{
                   ...
                   className='w-[15%] rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5'
                  key={index} value={data.code}>{data.code}-{data.country}</option>
                 ))}
               </select>
              ...
              boxShadow:"inset 0px -1px 0px rgba(255 255 255 0.18)"
               ...
               className='flex w-[calcl(100%-90px)] rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5'
               />
